...
Since version 1.1.2 Neothue uses [RE/flex](https://www.genivia.com/doc/reflex/html) and Bison for the frontend, but they are only required if you want to hack at the implementation as the generated frontend is included. 
