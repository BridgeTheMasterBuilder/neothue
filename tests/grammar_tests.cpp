...
int main()
{
 ...
 //
    ...
    { "{c1...c1 | c2}=b aba",                      "b"   },
    { "{c1...c1 | c2}=b abcba",                    "b"   },
    { "{c1...c1 | foo...foo}=b afoofooa",          "b"   },
    { "{c1...c1 | foo...foo}=b afoobbfooa",        "b"   },
    { "{c1...c1 | foo...foo | bar}=b foobarfoo",   "b"   },
    { "{c1...c1 | foo...foo | bar}=b fooabarafoo", "b"   },
  };
  ...
  const std::vector<std::pair<std::string, std::string>> ambiguous_patterns = {
    ...
    { "{c1...c1}=b abccca",                              "b"},
    { "{c1...c1}=b abcdba",                              "b"},
    { "{c1...c1 | foo...foo}=b afoobara",                "b"},
    { "{c1...c1 | foo...foo}=b bfoofooa",                "b"},
    { "{c1...c1 | foo...foo}=b bfoobara",                "b"},
    { "{c1...c1 | foo...foo}=b afoobcfooa",              "b"},
    { "{c1...c1 | foo...foo | bar}=b foobarbaz",         "b"},
    { "{c1...c1 | foo...foo | bar}=b fooabarbfoo",       "b"},
    { "{c1...c1 | foo...foo | bar}=b fooafoobarfoobfoo", "b"},
    { "{c1...c1 | foo...foo | bar}=b fooafoobarfooafoo", "b"},
  };
